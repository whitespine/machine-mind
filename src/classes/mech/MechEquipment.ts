...
import { IActionData, IBonusData, IDeployableData, ILicensedItemData, ISynergyData, ITagInstanceData } from '@/interface'
...
interface AllMechEquipmentData {
  ...
  effect: string
  talent_item?: boolean
  frame_id?: boolean; // If this item is frame-intrinsic
}
