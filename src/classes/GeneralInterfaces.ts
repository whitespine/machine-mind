...
// Shorthand for the post_final_write type of InsinuateHooks. Useful for function factories
export type PostInsinuateWriteHook<T extends EntryType> = (
    record: InsinuationRecord<T>,
    dest_reg: Registry,
    dest_cat: RegCat<T>
) => Promise<void> | void;

// Shorthand for the pre_final_write type of InsinuateHooks. Useful for function factories
export type PreInsinuateWriteHook<T extends EntryType> = (
    record: MidInsinuationRecord<T>,
    dest_reg: Registry,
    dest_cat: RegCat<T>
) => Promise<void> | void;

export interface InsinuateHooks {
     ...
     */
    post_final_write?: PostInsinuateWriteHook<EntryType>;
