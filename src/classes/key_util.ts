...
function reg_keyset_map(): any {
    if (!pending_reg_keyset) {
        pending_reg_keyset = {
            ...
            [EntryType.ENVIRONMENT]: keys<RegEnvironmentData>(),
            [EntryType.FACTION]: keys<RegFactionData>(),
            ...
            [EntryType.ORGANIZATION]: keys<RegOrganizationData>(),
            ...
            [EntryType.SITREP]: keys<RegSitrepData>(),
            [EntryType.SKILL]: keys<RegSkillData>(),
            [EntryType.STATUS]: keys<RegStatusData>(),
            [EntryType.TAG]: keys<RegTagTemplateData>(),
