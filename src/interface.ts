...
export { PackedCoreBonusData, RegistryCoreBonusData } from "./classes/pilot/CoreBonus";
...
export {PackedPilotArmorData, PackedPilotEquipmentData, PackedPilotGearData, PackedPilotWeaponData, RegPilotArmorData, RegPilotGearData, RegistryPilotWeaponData} from "./classes/pilot/PilotEquipment";
export { IPilotLoadoutData } from "./classes/pilot/PilotLoadout";
export { IFactionData } from "./classes/Faction";
export { PackedReserveData,  } from "./classes/pilot/reserves/Reserve";
